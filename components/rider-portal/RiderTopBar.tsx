...
/** Mirrors components/vendor-portal/VendorTopBar.tsx — same minimal-admin-shell top bar, pointed at /rider instead of /vendor. */
  ...
  return (
    <header className="vd-topbar">
      <div className="vd-topbar__left">
        ...
        <Link href="/rider" className="vd-topbar__brand">
